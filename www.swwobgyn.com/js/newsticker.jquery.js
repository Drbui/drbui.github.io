        ...
        getTwitterLink: function( entity ) {
            ...
            switch ( entity.type ) {
                ...
                case 'user_mentions':
                    ...
                    break;
                case 'hashtags':
                    return ' <a href="https://twitter.com/hashtag/' + entity.text + '?src=hash" ' + target + '> #' + entity.text + '</a>';                
                    break;  
				case 'media':
                    return '';                
                    break; 
				case 'symbols':
                     return '<a href="https://twitter.com/search?q=%24' + entity.text + '&src=ctag" ' + target + '>$' + entity.text + '</a>';             
                    break; 
            }
        },
