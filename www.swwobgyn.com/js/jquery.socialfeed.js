...
(function($, window, document, undefined) {
    $.fn.socialfeed = function(_options) {
        ...
        var defaults = {
            ...
            template_html:
            '<div class="social-feed-element {{? !it.moderation_passed}}hidden{{?}} item" dt-create="{{=it.dt_create}}" social-feed-id = "{{=it.id}}"> \
                <div class="content"> \
                    <div class="media-body"> \
                        <div class="text-wrapper"> \
                            <p class="social-feed-text">{{=it.text}} ...<span class="muted pull-right time_ago"> {{=it.time_ago}}</span></p> \
                        </div> \
                    </div> \
                </div> \
            </div>',
        ...
        var Utility = {
            ...
            wrapLinks: function(string, social_network) {
                ...
                if (social_network === 'twitter'){
                    string = string.replace(/(@|#)([A-Za-z0-9-_])+/g, Utility.wrapParseTwitter);
					string = string.replace('$MRK', '<a target="_blank" href="http://twitter.com/search?q=%24MRK&amp;src=ctag">$MRK<\/a>');
                } else {
                    string = string.replace(exp, Utility.wrapLinkTemplate);
                }
            ...
            // Parsing Twitter Usernames
            wrapParseTwitter: function(string){
            ...
            facebook: {
                ...
                utility: {
                    ...
                    prepareAttachment: function(element) {
                        ...
                        } else if (image_url.indexOf('safe_image.html') !== -1) {
                            image_url = Feed.facebook.utility.getExternalImageURL(image_url, 'url');

                        } else if (image_url.indexOf('app_full_proxy.html') !== -1) {
